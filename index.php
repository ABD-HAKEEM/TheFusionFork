...
<header class="text-slate-50 ">
        ...
        <nav class="main-nav flex justify-end items-left absolute top-0 right-44 w-full z-20 mt-10">
          <ul class="hidden lg:flex list_view space-x-8 mt-10px">
            <li class="relative group">
              <a href="/Unique-food-ingredients/flavours.html" class="hover:text-gray-600 text-White">Menu</a>
            ...
            <li class="relative group">
              <a href="/Unique-food-ingredients/Seasonings.html" class="hover:text-gray-600 text-White">The Fusion Fork</a>
      ...
      <div class="flex sm:hidden md:block max-w-screen-lg item-center">
      
        <div class="sm:hidden md:block absolute w-full z-20  mt-[80px] md:mt-2 lg:mt-2 font-serif text-white text-start ml-14 text-sm">
          Open Hours Monday - Sunday 11.00 Am To 12.00 Pm
        </div>
      </div>
        ...
        <div class="md:hidden ">
                ...
                <button id="toggleButton"
                    class="md:hidden p-2 bg-orange-400 text-white rounded absolute top-10 right-10 "
                    aria-expanded="false" aria-controls="sidebar"><i class="fa fa-bars "></i>
                </button>

                <!-- Sidebar Section -->
                <div id="sidebar"
                    class="relative sticky w-full md:w-80 h-screen bg-black overflow-hidden sidebar transform -translate-x-full md:translate-x-0">
...
<main>
      ...
      <section >
        <div
          class="concept concept-five main-nav flex justify-center items-center absolute  w-full z-20 mt-[200px] md:mt-72 lg:mt-72 font-serif text-slate-50">
      ...
      <section class="py-10">
    <div x-data>
        <h1 class="text-4xl font-bold text-center mt-10 text-gray-800">Product List</h1>
        <div class="container mx-auto mt-6 px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Product Listing -->
            <template x-for="product in $store.home.products" :key="product.id">
